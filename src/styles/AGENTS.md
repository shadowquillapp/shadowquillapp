...
| `components/` (13) | `_buttons.css`, `_inputs.css`, `_chips.css`, `_cards.css`, `_table.css`, `_modals.css`, `_menus.css`, `_links.css`, `_loaders.css`, `_code-blocks.css`, `_mode-toggle.css`, `_message-bubble.css`, `_status.css`, `_index.css` | Reusable UI primitives; one CSS file per widget type. |
| `features/` (6) | `_console-shell.css`, `_ollama.css`, `_workbench.css`, `_refine-panel.css`, `_find-highlight.css`, `_find-bar.css`, `_index.css` | Page/feature-scoped composite UI. |
