...
| `animations/` (1) | `_index.css` | `@keyframes` (md-spin, version-pulse, status-pulse, version-created, output-fade-in, version-switch, generating-border-shimmer, generating-soft-glow, generating-stop-pulse, page-fade-in). |
