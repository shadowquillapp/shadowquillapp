...
import type { TaskType, PresetOptions } from '@/app/studio/types';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <CustomSelect
              ...
              onChange={(v) => onFieldChange('frameRate', parseInt(v))}
              options={[
    ...
    return (
      <div className="mt-4">
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          />
          <span className="text-sm" style={{ color: 'var(--color-on-surface)' }}>Include unit tests</span>
        </label>
        <p className="mt-1 text-xs text-secondary ml-6" style={{ opacity: 0.8 }}>
      ...
      <div className="mt-4">
        <label className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            style={{ accentColor: 'var(--color-primary)' }}
          />
          <span className="text-sm" style={{ color: 'var(--color-on-surface)' }}>Require citations</span>
        </label>
        <p className="mt-1 text-xs text-secondary ml-6" style={{ opacity: 0.8 }}>
      ...
      <div className="space-y-4 mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => onFieldChange('targetWordCount', Math.max(50, Math.min(5000, parseInt(e.target.value) || 800)))}
              className="md-input w-full text-sm"
              style={{ padding: '8px 12px' }}
            />
          </div>
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            style={{ accentColor: 'var(--color-primary)' }}
          />
          <span className="text-sm" style={{ color: 'var(--color-on-surface)' }}>Include section headings</span>
        </label>
      </div>
    );
  }
